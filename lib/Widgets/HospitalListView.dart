...
class HospitalListView extends StatefulWidget {
  ...
  const HospitalListView({Key key,this.callBack}) : super(key: key);

  @override
  _HospitalListViewState createState() => _HospitalListViewState();
}

class _HospitalListViewState extends State<HospitalListView> with TickerProviderStateMixin{
            ...
            return GridView(
              ...
              children: List<Widget>.generate(
                Category.popularServicesList.length,
                    (int index) {
                  final int count = Category.hospitals.length;
                  ...
                  return HospitalListTile(
                    ...
                    category: Category.hospitals[index],
                    animation: animation,
                    animationController: animationController,
                  );
                },
